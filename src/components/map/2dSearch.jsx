          ...
          <div className={`flex flex-col p-4 transition-opacity duration-300 ease-in-out ${collapsed ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className="flex mb-4 w-full  text-sm rounded gap-1 px-1 rounded-md bg-gray-200">
              ...
              <button
                ...
                className={`flex-grow p-2  rounded rounded-md my-1 ${activeTab === 'transactions' ? 'bg-white text-black border-gray-300 shadow shadow-md' : 'bg-gray-200 text-gray-700 border-gray-300'}`}
              >
                Transactions
              </button>
              <button
                onClick={() => setActiveTab('tenantAccount')}
                className={`flex-grow p-2  rounded rounded-md my-1 ${activeTab === 'tenantAccount' ? 'bg-white text-black border-gray-300 shadow shadow-md' : 'bg-gray-200 text-gray-700 border-gray-300'}`}
              >
                Tenant Account
              </button>
            </div>
