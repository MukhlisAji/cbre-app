                ...
                <div className="bg-neutral-100 shadow-lg py-3 px-3 rounded rounded-md">
                    ...
                    <div className="relative overflow-hidden rounded rounded-sm border border-gray-300 shadow-sm w-full">
                        <table className="min-w-full">
                            <thead className="bg-c-teal">
                                <tr>
                                    <th className="px-6 py-3 text-left font-semibold text-white sm:w-3/12 md:w-3/8 lg:w-3/8">Building Name</th>
                                    <th className="px-6 py-3 text-left font-semibold text-white sm:w-2/12 md:w-2/8 lg:w-2/8">Postal Code</th>
                                    <th className="px-4 py-3 text-left font-semibold text-white sm:w-2/12 md:w-2/8 lg:w-2/8">Building Owner</th>
                                    <th className="px-4 py-3 text-left font-semibold text-white sm:w-1/12 md:w-1/8 lg:w-1/8">Landmark Area</th>
                            ...
                            <table className="min-w-full">
                                <tbody className="bg-white">
                                    {filteredTemplates.map((building, index) => (
                                        <tr key={building.id} className={`${index % 2 === 0 ? 'bg-gray-100' : ''}`}>
                                            <td className="px-6 py-2 text-neutral-700 border sm:w-3/12 md:w-3/8 lg:w-3/8">{building.buildingName}</td>
                                            <td className="px-6 py-2 text-neutral-700 border sm:w-2/12 md:w-2/8 lg:w-2/8">{building.postalCode}</td>
                                            <td className="px-6 py-2 text-neutral-700 border sm:w-2/12 md:w-2/8 lg:w-2/8">{building.buildingOwner}</td>
                                            <td className="px-6 py-2 text-neutral-700 border sm:w-2/12 md:w-2/8 lg:w-2/8">{building.landAreaRemark}</td>
                                            <td className="px-6 py-2 text-neutral-700 border sm:w-1/12 md:w-1/8 lg:w-1/8">
                                                <button onClick={() => handleEdit(building)} className="text-blue-600 hover:underline">Edit</button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
                    ...
                    >
                        <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full p-6">
                            <h2 className="text-lg font-semibold text-gray-900 mb-4">Edit Building</h2>
                            {currentBuilding && (
                                <form onSubmit={handleSave} className="space-y-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCurrentBuilding({ ...currentBuilding, 'Building Name': e.target.value })}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            value={currentBuilding.postalCode}
                                            onChange={(e) => setCurrentBuilding({ ...currentBuilding, Floor: e.target.value })}
                                            className="px-2.5 py-1 mt-1 block w-full rounded-md border border-sm focus:outline-none focus:ring-1 focus:ring-c-teal hover:ring-1 hover:ring-c-teal text-neutral-700 font-normal transition duration-150 ease-in-out"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700">Building Owner</label>
                                        <input
                                            type="text"
                                            value={currentBuilding.buildingOwner}
                                            onChange={(e) => setCurrentBuilding({ ...currentBuilding, 'Unit No': e.target.value })}
                                            className="px-2.5 py-1 mt-1 block w-full rounded-md border border-sm focus:outline-none focus:ring-1 focus:ring-c-teal hover:ring-1 hover:ring-c-teal text-neutral-700 font-normal transition duration-150 ease-in-out"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700">Landmark Area</label>
                                        <input
                                            type="text"
                                            value={currentBuilding.landAreaRemark}
                                            onChange={(e) => setCurrentBuilding({ ...currentBuilding, 'Unit No': e.target.value })}
                                            className="px-2.5 py-1 mt-1 block w-full rounded-md border border-sm focus:outline-none focus:ring-1 focus:ring-c-teal hover:ring-1 hover:ring-c-teal text-neutral-700 font-normal transition duration-150 ease-in-out"
                                        />
                                    </div>
